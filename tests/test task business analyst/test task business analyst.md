...
## Блок 2. Анализ данных по просрочкам
...
### 2.1. Сформулируйте 3 вывода, которые эти данные позволяют сделать, и 2 вывода, которые сделать НЕЛЬЗЯ (хотя их часто делают).
...
### 2.2. Приведите расчёты: распределение по участкам — в позициях и в днях просрочки; доля строк без указанной причины; доля дней просрочки, не объяснённых причиной. Числа обязательны.
...
### 2.3. Постройте диаграмму Парето по причинам опозданий — или обоснуйте, почему на этих данных её строить нельзя.
...
### 2.4. Предложите 3 первоочередных действия. По каждому: что именно делаем, кто владелец, что изменится и как мы это увидим в цифрах.
...
### 2.5. Назовите 5 вопросов начальнику производства и 3 источника данных, которые вы запросите до того, как делать выводы.
...
## Блок 3. Процесс обработки рекламаций
...
### 3.1. Определите границы процесса: стартовое событие, конечное событие, клиент процесса, выход. Назовите владельца и обоснуйте выбор должности.
...
### 3.2. Опишите AS-IS — BPMN-фрагмент или таблица «Шаг — Роль — Система — Вход — Выход — Срок», минимум 8 шагов, участники: Клиент, Продажи, Сервис, ОТК.
...
### 3.3. Назовите 5 разрывов. По каждому: в чём риск и как он проявляется в отчётности.
...
### 3.4. Предложите ОДНО изменение ТО-ВЕ с максимальным эффектом при минимальных затратах. Обоснуйте, почему именно оно первое.
...
## Блок 4. Карточка процесса для пользователя — 25 минут, 20 баллов
...
### 4.2. Сделайте карточку процесса «Обработка рекламации» на ОДНУ страницу А4 для менеджера сервисной службы: что делать, в какой срок, в какой системе, что считается результатом, к кому эскалировать при отклонении. Добавьте 3 вопроса FAQ с ответами — из тех, что реально возникают (например: «Клиент требует замену, а гарантия истекла»).

Ограничения: одна страница, шрифт не мельче 10 пт, без оборотов «в установленном порядке», «осуществляется», «в целях обеспечения».

---

## Блок 5. Каталог процессов и поиск — 15 минут, 15 баллов

### 5.1. Перечислите обязательные атрибуты карточки процесса (не менее 8). По каждому — одна строка: зачем он нужен.
...
### 5.2. Как сотрудник найдёт нужный процесс? Сформулируйте 3 запроса так, как их реально введёт кладовщик или менеджер (не терминами аналитика), и покажите, за счёт чего поиск сработает.
...
### 5.3. Опишите структуру каталога, которая останется удобной при 200 описанных процессах. Покажите верхний уровень — он должен помещаться на один экран.
...
### 5.4. Как поддерживать актуальность: версионирование, срок пересмотра, кто инициирует изменение, что происходит с устаревшей версией.
...
## Блок 6. Метрики и управление — 10 минут, 10 баллов

### 6.1. Предложите 4 метрики процесса обработки рекламаций: название, формула, источник данных, целевое значение, периодичность.
...
### 6.2. Кто владелец процесса и что конкретно он вправе менять без согласования.
...
### 6.3. Как через 6 месяцев доказать руководству, что описание процессов дало эффект? Назовите 2–3 измеримых доказательства.
